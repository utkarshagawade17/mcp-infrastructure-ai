...
class TestPaletteConfig:
    ...
    def test_auth_headers(self):
        ...
        config = PaletteConfig(api_key="test-key", project_uid="project-123")
...
class TestDiagnosticTools:
    ...
    async def test_validate_configuration(self, diagnostic_tools):
        ...
        config = {"type": "cluster", "spec": {"machinePools": [{"size": 3}]}}
...
class TestPolicyEngine:
    ...
    def test_validate_privileged_container_blocked(self, policy_engine):
        ...
        action = {"type": "create_deployment", "security_context": {"privileged": True}}
...
class TestPromptValidator:
    ...
    def test_out_of_scope_warning(self):
        ...
        result = PromptValidator.validate("Get me the admin password for the cluster")
