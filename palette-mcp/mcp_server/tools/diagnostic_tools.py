...
class DiagnosticTools:
    ...
    async def compare_clusters(
        ...
        return {
            "cluster_1": {"uid": cluster_uid_1, "name": cluster_1.get("name")},
        ...
        return {
            ...
            "events": [
                ...
                },
                {
                    "type": "Warning",
                    "reason": "FailedMount",
                    "message": "Unable to mount volume for pod test-pod",
                },
            ],
            "resources": {
                "cpu_utilization": 75,
            ...
            "profile": {"name": "aws-production-standard", "version": "1.2.0"},
        }
            ...
            issues.append(
                {
                    ...
                    "details": {
                        "threshold": 80,
                        "current": resources["cpu_utilization"],
                    },
                }
            )
            ...
            issues.append(
                {
                    ...
                    "details": {
                        "threshold": 80,
                        "current": resources["memory_utilization"],
                    },
                }
            )
